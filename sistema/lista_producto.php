...
<body>
    ...
    <section id="container">
        ...
        <h1><i class="fa fas-cube"></i>Lista de productos</h1>
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT p.codproducto, p.descripcion, p.precio, p.existencia, pr.proveedor, p.foto
								 ...
								 FROM producto p INNER JOIN proveedor pr ON p.proveedor = pr.codproveedor WHERE p.estatus = 1 ORDER BY p.codproducto DESC LIMIT $desde,$por_pagina 
				");
			...
			?>
				<tr class="row<?php echo $data["codproducto"]; ?>">
					...
					<td class="img_producto"><img src="<?php echo $foto; ?>" alt="<?php echo 
					$data["descripcion"]; ?>"></td>
					...
					<td>
                        ...
                        |
                        <a class="link_delete del_producto" href="eliminar_confirmar_producto.php" product="<?php echo $data["codproducto"]; ?>">Eliminar</a>
                        </td>
					<?php } ?>
				</tr>
