...
<body>
	...
	<section id="container">
		...
		<form action="buscar_proveedor.php" method="get" class="form_search">
			...
			<input type="submit" value="Buscar proveedor" class="btn_search">
		</form>
		...
		<?php 
			...
			?>
				<tr>
					...
					<td>
						<a class="link_edit" href="editar_proveedor.php?id=<?php echo $data["codproveedor"]; ?>"><i class="far fa-edit"> Editar</a>
						|
